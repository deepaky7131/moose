...
#ifndef PDMECHANICSACTION_H
#define PDMECHANICSACTION_H

#include "Action.h"

class PDMechanicsAction;

template <>
InputParameters validParams<PDMechanicsAction>();

/**
 * Action class to setup peridynamic models for solid mechanics problems
 */
class PDMechanicsAction : public Action
{
public:
  PDMechanicsAction(const InputParameters & params);
