...
Kernel `FiniteSNOSPDKernel` calculates the residual and jacobian of the force density integral for self-stabilized non-ordinary state-based models under finite strain assumptions.
