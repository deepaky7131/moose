...
validParams<GeneralizedPlaneStrainPDAction>()
{
  ...
  params.addParam<std::vector<SubdomainName>>("block",
                                              ...
                                              "GeneralizedPlaneStrainPDAction will be applied "
                                              "to");
...
GeneralizedPlaneStrainPDAction::act()
{
  if (_current_task == "add_kernel")
  {
    ...
    {
      case 0:
        k_type = "GeneralizedPlaneStrainOSPDOffDiag"; // Based on ordinary state-based model
        break;
      case 1:
        k_type = "GeneralizedPlaneStrainSNOSPDOffDiag"; // Based on bond-associated non-rodinary
                                                        // state-based model
        break;
      default:
