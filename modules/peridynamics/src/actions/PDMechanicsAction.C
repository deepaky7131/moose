...
#include "PDMechanicsAction.h"

#include "libmesh/string_to_enum.h"

registerMooseAction("PeridynamicsApp", PDMechanicsAction, "add_aux_variable");
registerMooseAction("PeridynamicsApp", PDMechanicsAction, "add_kernel");
registerMooseAction("PeridynamicsApp", PDMechanicsAction, "add_user_object");
registerMooseAction("PeridynamicsApp", PDMechanicsAction, "setup_quadrature");

template <>
InputParameters
validParams<PDMechanicsAction>()
{
...
PDMechanicsAction::PDMechanicsAction(const InputParameters & params)
  : Action(params),
...
PDMechanicsAction::act()
{
  ...
  else if (_current_task == "add_kernel")
  {
    ...
    mooseError("Task error in PDMechanicsAction");
}

std::string
PDMechanicsAction::getKernelType()
{
  std::string type;
...
InputParameters
PDMechanicsAction::getKernelParameters(std::string type)
{
